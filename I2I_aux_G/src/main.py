...
def main():
    ...
    parser.add_argument('--crop', type=str, default='no', help='which crop is used for input image: center, random, no')
    ...
    parser.add_argument('--Enc_from_step3', action='store_true', help='The encoder model')
    ...
    parser.add_argument('--aux_w', type=float, default=0.01, help='control the importance of the auxliary')
